...
angular.module('ezseed').controller('sidebarCtrl', [
  ...
  '$stateParams',
  '$translate',
  function ($scope, $http, paths, size, $log, $rootScope, $recent, $stateParams, $translate) {
    $scope.paths = paths;
...
angular.module('ezseed').factory('httpInterceptor', [
  ...
  '$log',
  '$location',
  function ($loaderService, $q, $log, $location) {
    return {
...
/******************************************************************************
Bin-packing algorithm - https://github.com/jakesgordon/bin-packing
