...
angular.module('ezseed')
.controller('DesktopTypeCtrl', ["$scope", "$stateParams", "$rootScope", "$recent", "$socket", "$loaderService", "$state", "$paginate", function($scope, $stateParams, $rootScope, $recent, $socket, $loaderService, $state, $paginate) {
...
angular.module('ezseed')
.service('$colorThief', ["$http", "$q", function($http, $q) {
...
angular.module('ezseed')
.controller('MovieCtrl', ["$scope", "$log", "movie", "$localStorage", "$hasWatched", function($scope, $log, movie, $localStorage, $hasWatched) {
